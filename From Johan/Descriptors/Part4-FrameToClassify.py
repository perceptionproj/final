...
codebook = pickle.load(open("/home/jo/PycharmProjects/Perception/desc/Codebooks/Codebook.out", 'rb'))
clf = pickle.load(open('/home/jo/PycharmProjects/Perception/desc/SVM_Models/SVM_model.out', 'rb'))

#desc= cv2.xfeatures2d.SURF_create(600) #TJEK THREDSHOLD !!!!
desc = cv2.xfeatures2d.SIFT_create(contrastThreshold=0.01,edgeThreshold=10) #,contrastThreshold=0.01,edgeThreshold=20

#path1 =  "/home/jo/PycharmProjects/Perception/SIFT/No_backround/object181.jpg"
#path1 = "/home/jo/Downloads/kop3.jpg"
